...
public class demo {
	...
	ChromeDriver driver= new ChromeDriver(op);
		...
		driver.findElement(By.xpath("//input[@class='form-control check-box']")).sendKeys("harsh");
	 ...
	 // date.sendKeys("09192023");
		...
		//driver.findElement(By.xpath("//li[@class='row mx-0 activeWalletPayment']")).click();
	 driver.findElement(By.xpath("//div[@class='popupinner walletpaymement_inner ']//button")).click();
